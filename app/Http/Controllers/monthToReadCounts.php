...
class monthToReadCounts extends Controller
{
    ...
    public function index($userID){
        ...
        $monthToReadCount = Book::where('Read', 1)->where('user_id', $userID)->selectRaw("created_at as Date")->selectRaw("COUNT(books.Read) as read_count")->groupBy(DB::raw('YEAR(created_at)'), DB::raw('MONTH(created_at)'))->get();
